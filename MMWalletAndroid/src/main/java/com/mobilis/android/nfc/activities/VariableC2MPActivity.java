...
public class VariableC2MPActivity extends Activity implements View.OnClickListener, A2ACallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        {
            editButton.setTextColor(getResources().getColor(R.color.LOGIN_TEXT_COLOR));
        }
...
/*        amountET.addTextChangedListener(new TextWatcher() {
    ...
    private void saveVariableAmount() {
        String savedAmount = CurrencyUtils.getInstance().getCleanAmount(amountET.getText().toString());//df.format(Double.parseDouble(textModifier.getAmount().toString()));
    ...
    private boolean isNFCEnabled() {
        return nfcForegroundUtil.hasReaderOrNFC();
    }
