...
public class DeveloperAuthenticationProvider extends
    ...
    private static final String developerProvider = "TestApp";
    private static final String cognitoSampleDeveloperAuthenticationAppEndpoint = "TestAppServer";
...
/*        identityId = CognitoSyncClientManager.credentialsProvider.getCachedIdentityId();
      if (identityId == null) {
        ...
        identityId =mContext.getString(R.string.GLOBAL_IDENTITY_ID);// "us-east-1:98920f2e-9f77-43ce-b64e-7bd3671b6c86";
