...
//    GOT_NEW_PIN_LOGIN("GOT_NEW_PIN_LOGIN"),
    ...
    TERMINAL_REGISTRATION("TERMINAL_REGISTRATION"),
    APPLICATION_ACCOUNT_TAB_REFRESH_LIST("APPLICATION_ACCOUNT_TAB_REFRESH_LIST"),
    TAP("TAP"),
    MERCHANT_SERVICE_COMMISSION_TRANSFER("MERCHANT_SERVICE_COMMISSION_TRANSFER"),
    MERCHANT_SERVICE_MERCHANT_VOUCHER("MERCHANT_SERVICE_MERCHANT_VOUCHER"),
    DEMO_WALLET_WAIT_FOR_PIN("DEMO_WALLET_WAIT_FOR_PIN"),
    DEMO_WALLET_WAIT_FOR_PIN_VALUE("DEMO_WALLET_WAIT_FOR_PIN_VALUE");
