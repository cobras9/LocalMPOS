...
/*        amountET.addTextChangedListener(new TextWatcher() {
            ...
            case R.id.Fragment_CashIn_Button_Pay:
                ...
                if(accountIdET.getText().toString().isEmpty())
                {
                    ...
                    if (getResources().getBoolean(R.bool.CASH_IN_EXCHANGE_QUOTE_ON)) {
                        ...
                        vModel.setWorkingAmount(CurrencyUtils.getInstance().getCleanAmount(amountET.getText().toString()));
                ...
                else if(action.equalsIgnoreCase(INTENT.NFC_SCANNED.toString()))
                {
                    if(NFCDialog != null && NFCDialog.isShowing())
                    {
                        ...
                        if (getResources().getBoolean(R.bool.CASH_IN_EXCHANGE_QUOTE_ON)) {
                            ...
                            model.setMsisdnTransaction(false);
                            model.setWorkingAmount(CurrencyUtils.getInstance().getInstance().getCleanAmount(amountET.getText().toString()));
                            model.getConnTaskManager().startBackgroundTask();
                        }
    ...
    private void showExchangeQuotationDialog(Intent intent){
        ...
        title.setBackgroundColor(getResources().getColor(R.color.MAIN_FRAGMENT_BACKGROUND_COLOR));
        title.setPadding(10, 30, 10, 30);
        title.setGravity(Gravity.CENTER);
        title.setTextColor(getResources().getColor(R.color.TEXT_NORMAL));
        ...
        amountTV.setText(CurrencyUtils.getInstance().getCleanAmount(amountET.getText().toString()));//textModifier.getAmount());
