...
public class ServerConfigurationFragment extends ApplicationActivity.PlaceholderFragment{
   ...
   // private EditText editTextServerPortMask;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        editTextServerIP = (EditText) rootView.findViewById(R.id.editTextServerIP);
       ...
       // registerTextChangeListeners(editTextServerPort, editTextServerPortMask);
        ...
        updateButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imm.hideSoftInputFromWindow(editTextServerIP.getWindowToken(), 0);
                if(editTextServerIP.getText() == null){
                    progressBar.setVisibility(View.GONE);
                    resultTV.setText(getString(R.string.SERVER_IP_NOT_ENTERED));
                    resultTV.setVisibility(View.VISIBLE);
                    return;
                }
                if(editTextServerPort.getText() == null){
                    progressBar.setVisibility(View.GONE);
                    resultTV.setText(getString(R.string.SERVER_PORT_NOT_ENTERED));
                    resultTV.setVisibility(View.VISIBLE);
                    return;
                }
                final String newIP =editTextServerIP.getText().toString();// fixUpServerIP(editTextServerIPMask.getText().toString());
                final String newPort = editTextServerPort.getText().toString();
