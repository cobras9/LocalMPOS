 ...
 */
public class UtilitiesFragment extends NFCFragment implements View.OnClickListener , DialogInterface.OnDismissListener, DialogInterface.OnShowListener  {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        msisdnET = (EditText) rootView.findViewById(R.id.Fragment_UtitliesTV_EditText_MSISDN);
        ...
        if(getResources().getBoolean(R.bool.LOAD_TRANSFERCODES_FROM_SERVER)) {
            try {
                ...
                Log.d("Lewis", "Lewis FragmentUtil  savedCurr " + savedCurr);
                Log.d("Lewis", "Lewis FragmentUtil  currencyCode " + currencyCode);
                payees = TransferCode.currencyBillPayees.get(currencyCode);
                Log.d("Lewis", "Lewis FragmentUtil  payees size " + payees.size());
                payees = TransferCode.currencyBillPayees.get(currencyCode);
                if (payees != null) {
