...
import com.mobilis.android.nfc.util.TimeFormatter;
...
public abstract class AbstractModel{
    ...
    public void saveDefaultCurrency(String currency){
        ...
        CurrencyUtils.getInstance().setCurrency();
...
//        mp.start();
	...
	public TxlDomain generateTXLId(String txlType){
		...
		if (lastTxl.getTxlId() != null) {
			Log.v("generateTXLId(): ", "lastTxl is not null and will create new one now");
			txlId = constructNewTxlId(lastTxl.getTxlId());
			Log.v("generateTXLId(): ", "new txl is: "+txlId);
		}
		else{
...
//        return "35372606614014900"
        ...
        return Settings.System.getString(context.getContentResolver(),Secure.ANDROID_ID).toUpperCase(Locale.US);
	}
	...
	public String getDate(){
		SimpleDateFormat sdf = TimeFormatter.getDateFormatter();//new SimpleDateFormat("dd-MM-yyyy");
		Date date = new Date();
	...
	public String getTime(){
		SimpleDateFormat tf = TimeFormatter.getTimeFormatter();//new SimpleDateFormat("HH:mm:ss");
		Date date = new Date();
    ...
    public static String getDateAndTime(){
        SimpleDateFormat sdf = TimeFormatter.getDateTimeFormatter();//new SimpleDateFormat("yyyyMMdd_HHmmss");
