...
public class LastTransactions extends AbstractModel {
	...
	public void verifyPostTaskResults() {
		...
		else if(getResponseStatus() == 0 || getResponseStatus() == 1)
		{
...
//                                String removeNull = rowTxl[1].toString().replace("null", "    ");
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            //TODO Not needed as server should return the set of transactions  04032015
            //TODO USing configure file to determine whether to keep requesting transactions 01/04/2015
            if(getActivity().getResources().getBoolean(R.bool.AUTO_REQUEST_TRANSACTIONS)) {
