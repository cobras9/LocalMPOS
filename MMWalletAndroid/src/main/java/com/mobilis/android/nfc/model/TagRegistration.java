...
public class TagRegistration extends AbstractModel implements SpecialTxl {
    ...
    public String getRequestParameters() {
        ...
        if (getTagOwnerName() != null) {
            buffer.append(getFullParamString(getResString(R.string.REQ_TAG_OWNER_NAME), getTagOwnerName(), false));
        } else {
            buffer.append(getFullParamString(getResString(R.string.REQ_TAG_OWNER_NAME), getMsisdn(), false));
        }
...
//        txlId.append(getAndroidId(context));
