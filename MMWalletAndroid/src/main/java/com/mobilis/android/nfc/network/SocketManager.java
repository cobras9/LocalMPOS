...
public class SocketManager {
    ...
    private final int CONNECTION_TIME_OUT = 90000;
    ...
    private void getConnDetails() {
        ...
        String port = model.getActivity().getString(R.string.SERVER_PORT);
        SERVER_IP = model.getActivity().getString(R.string.SERVER_IP);
        ...
        if(LoginActivity.mainSecurePreferences.contains(appVersionCode + SecurePreferences.KEY_SERVER_PORT)) {
            SERVER_PORT =  Integer.parseInt(LoginActivity.mainSecurePreferences.getString(appVersionCode + SecurePreferences.KEY_SERVER_PORT, port));
        }else{
...
//        }
    ...
    public void createSSLSocket() throws IOException{
        ...
        if(socket == null || socket.isClosed() || createNewSocket){
            ...
            new Timer().schedule(task, CONNECTION_TIME_OUT);
        }
