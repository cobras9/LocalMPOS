...
public class WalletMenuOptions {
    ...
    private boolean commissionTransferAvailable;
    private boolean merchantVoucher;

    public boolean isMerchantVoucher() {
        return merchantVoucher;
    }

    public void setMerchantVoucher(boolean merchantVoucher) {
        this.merchantVoucher = merchantVoucher;
    }

    public boolean isCommissionTransferAvailable() {
        return commissionTransferAvailable;
    }

    public void setCommissionTransferAvailable(boolean commissionTransferAvailable) {
        this.commissionTransferAvailable = commissionTransferAvailable;
    }
